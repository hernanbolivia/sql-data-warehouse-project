...
Script Purpose:
    ...
    If the database exists, it is dropped and recreated. Addionally, the script sets up three schemas within
    the database: 'bronze', 'silver', and 'gold'.

WARNING:
    Running this script will drop the entire 'DataWarehouse' database if it exists.
    All data int database will be permanently deleted. Proceed with caution and 
